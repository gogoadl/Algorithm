...
public class P2 {
    ...
    public static void main(String[] args) {
        P2 p2 = new P2();
//        p2.solution(new int[][] {{1,4},{0,0},{2,3}});
//        p2.solution(new int[][] {{1,0,2},{0,0,0},{5,0,5},{4,0,3}});
//        p2.solution(new int[][] {{4,1,2,3}});
        p2.solution(new int[][] {{4,3,0,0},{5,5,5,0},{1,0,0,0},{2,0,0,0}});
